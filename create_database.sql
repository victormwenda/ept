...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Add_Index_in_r_tb_assay` ()  CREATE INDEX r_tb_assay_indexes ON r_tb_assay (short_name)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `Add_Index_in_Shipment_Participent_map` ()  CREATE INDEX indexing_in_spm  ON shipment_participant_map (shipment_id,is_excluded,participant_id)$$
...
--
-- Indexes for table `country_shipment_map`
--
ALTER TABLE `country_shipment_map`
  ADD PRIMARY KEY (`country_id`,`shipment_id`),
...
ALTER TABLE `enrollments`
  ADD PRIMARY KEY (`scheme_id`,`participant_id`),
...
--
-- Indexes for table `gxalert_result`
--
ALTER TABLE `gxalert_result`
  ADD PRIMARY KEY (`result_id`),
  ADD UNIQUE KEY `gxalert_result_result_id` (`map_id`,`sample_id`);
...
--
-- Indexes for table `participant_monthly_indicators`
--
ALTER TABLE `participant_monthly_indicators`
...
--
-- Indexes for table `ptcc_country_map`
--
ALTER TABLE `ptcc_country_map`
  ADD PRIMARY KEY (`admin_id`,`country_id`),
...
--
-- Indexes for table `push_notification_token`
--
ALTER TABLE `push_notification_token`
  ADD PRIMARY KEY (`push_notification_token_id`),
  ADD KEY `dm_id` (`dm_id`),
  ADD KEY `push_notification_token` (`push_notification_token`);
...
--
-- Indexes for table `report_download_log`
--
ALTER TABLE `report_download_log`
  ADD KEY `shipment_id` (`shipment_id`),
  ADD KEY `participant_id` (`participant_id`);

--
-- Indexes for table `response_not_tested_reason`
--
ALTER TABLE `response_not_tested_reason`
  ADD PRIMARY KEY (`not_tested_reason_id`);
...
ALTER TABLE `r_tb_assay`
  ADD PRIMARY KEY (`id`),
  ADD KEY `r_tb_assay_indexes` (`short_name`);
...
ALTER TABLE `shipment`
  ...
  ADD KEY `shipment_ibfk_3_idx` (`follows_up_from`);
...
ALTER TABLE `shipment_participant_map`
  ...
  ADD KEY `indexing_in_spm` (`shipment_id`,`is_excluded`,`participant_id`) USING BTREE;
...
--
-- Indexes for table `temp_push_notification`
--
ALTER TABLE `temp_push_notification`
  ADD PRIMARY KEY (`temp_id`);
...
--
-- AUTO_INCREMENT for table `gxalert_result`
--
ALTER TABLE `gxalert_result`
...
--
-- AUTO_INCREMENT for table `participant_monthly_indicators`
--
ALTER TABLE `participant_monthly_indicators`
...
--
-- AUTO_INCREMENT for table `push_notification_token`
--
ALTER TABLE `push_notification_token`
  MODIFY `push_notification_token_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `response_not_tested_reason`
--
ALTER TABLE `response_not_tested_reason`
  MODIFY `not_tested_reason_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `r_dbs_eia`
  MODIFY `eia_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `r_enrolled_programs`
  MODIFY `r_epid` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `r_site_type`
  MODIFY `r_stid` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `temp_push_notification`
--
ALTER TABLE `temp_push_notification`
  MODIFY `temp_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `country_shipment_map`
--
ALTER TABLE `country_shipment_map`
  ADD CONSTRAINT `country_shipment_map_ibfk_1` FOREIGN KEY (`shipment_id`) REFERENCES `shipment` (`shipment_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `country_shipment_map_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `gxalert_result`
--
ALTER TABLE `gxalert_result`
  ADD CONSTRAINT `gxalert_result_ibfk_1` FOREIGN KEY (`map_id`) REFERENCES `shipment_participant_map` (`map_id`) ON DELETE SET NULL;

--
-- Constraints for table `instrument`
--
ALTER TABLE `instrument`
  ADD CONSTRAINT `instrument_ibfk_2` FOREIGN KEY (`participant_id`) REFERENCES `participant` (`participant_id`);

--
-- Constraints for table `participant_monthly_indicators`
--
ALTER TABLE `participant_monthly_indicators`
  ADD CONSTRAINT `participant_monthly_indicators_ibfk_1` FOREIGN KEY (`participant_id`) REFERENCES `participant` (`participant_id`) ON DELETE CASCADE;

--
-- Constraints for table `ptcc_country_map`
--
ALTER TABLE `ptcc_country_map`
  ADD CONSTRAINT `ptcc_country_map_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `system_admin` (`admin_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ptcc_country_map_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `push_notification_token`
--
ALTER TABLE `push_notification_token`
  ADD CONSTRAINT `dm_id` FOREIGN KEY (`dm_id`) REFERENCES `data_manager` (`dm_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `reference_result_vl`
  ADD CONSTRAINT `reference_result_vl_ibfk_1` FOREIGN KEY (`shipment_id`) REFERENCES `shipment` (`shipment_id`) ON DELETE CASCADE;

--
-- Constraints for table `report_download_log`
--
ALTER TABLE `report_download_log`
  ADD CONSTRAINT `report_download_log_ibfk_3` FOREIGN KEY (`shipment_id`) REFERENCES `shipment` (`shipment_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `report_download_log_ibfk_4` FOREIGN KEY (`participant_id`) REFERENCES `participant` (`participant_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `response_result_vl`
  ADD CONSTRAINT `response_result_vl_ibfk_1` FOREIGN KEY (`shipment_map_id`) REFERENCES `shipment_participant_map` (`map_id`) ON DELETE CASCADE;

--
-- Constraints for table `shipment`
--
ALTER TABLE `shipment`
  ADD CONSTRAINT `shipment_ibfk_1` FOREIGN KEY (`scheme_type`) REFERENCES `scheme_list` (`scheme_id`),
  ADD CONSTRAINT `shipment_ibfk_3` FOREIGN KEY (`follows_up_from`) REFERENCES `shipment` (`shipment_id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `shipment_ibfk_4` FOREIGN KEY (`distribution_id`) REFERENCES `distributions` (`distribution_id`) ON DELETE CASCADE;

--
-- Constraints for table `shipment_participant_map`
--
ALTER TABLE `shipment_participant_map`
  ADD CONSTRAINT `shipment_participant_map_ibfk_3` FOREIGN KEY (`shipment_id`) REFERENCES `shipment` (`shipment_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `shipment_participant_map_ibfk_4` FOREIGN KEY (`participant_id`) REFERENCES `participant` (`participant_id`) ON DELETE CASCADE;
COMMIT;
