...
--
-- Host: 127.0.0.1    Database: eanalyze_staging
-- ------------------------------------------------------
...
CREATE TABLE `shipment_participant_map` (
  ...
  PRIMARY KEY (`map_id`),
  KEY `indexing_in_spm` (`shipment_id`,`is_excluded`,`participant_id`) USING BTREE,
  KEY `shipment_participant_map_ibfk_4` (`participant_id`),
...
--
-- Dumping events for database 'eanalyze_staging'
--

--
-- Dumping routines for database 'eanalyze_staging'
--
/*!50003 DROP PROCEDURE IF EXISTS `Add_Indexing_in_reference_result_tb` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Add_Indexing_in_reference_result_tb`()
CREATE INDEX indexing_reference_result_tb ON reference_result_tb (shipment_id,sample_id,is_excluded) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Add_Index_in_respose_result_tb` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Add_Index_in_respose_result_tb`()
CREATE INDEX index_in_response_res_tb ON response_result_tb (sample_id,shipment_map_id) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Add_Index_in_r_tb_assay` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Add_Index_in_r_tb_assay`()
CREATE INDEX r_tb_assay_indexes ON r_tb_assay (short_name) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Add_Index_in_Shipment_Participent_map` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Add_Index_in_Shipment_Participent_map`()
CREATE INDEX indexing_in_spm  ON shipment_participant_map (shipment_id,is_excluded,participant_id) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
-- Dump completed on 2021-02-18 11:42:54
