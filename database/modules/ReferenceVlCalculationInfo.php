<?php 
	...
	*/
	public function insert($shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range,$redundancy_check= false, $printSQL = false) {
		...
		return $this->reference_vl_calculation->insert_prepared_records($shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range,$redundancy_check,$printSQL );
	}
...
$manual_mean = $reference_vl_calculation_row_items ['manual_mean'];
	if ($manual_mean  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_mean', $manual_mean  );
}
$manual_sd = $reference_vl_calculation_row_items ['manual_sd'];
	if ($manual_sd  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_sd', $manual_sd  );
}
$manual_cv = $reference_vl_calculation_row_items ['manual_cv'];
	if ($manual_cv  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_cv', $manual_cv  );
}
$manual_q1 = $reference_vl_calculation_row_items ['manual_q1'];
	if ($manual_q1  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_q1', $manual_q1  );
}
$manual_q3 = $reference_vl_calculation_row_items ['manual_q3'];
	if ($manual_q3  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_q3', $manual_q3  );
}
$manual_iqr = $reference_vl_calculation_row_items ['manual_iqr'];
	if ($manual_iqr  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_iqr', $manual_iqr  );
}
$manual_quartile_low = $reference_vl_calculation_row_items ['manual_quartile_low'];
	if ($manual_quartile_low  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_quartile_low', $manual_quartile_low  );
}
$manual_quartile_high = $reference_vl_calculation_row_items ['manual_quartile_high'];
	if ($manual_quartile_high  != null) {
	$html_export .= $this->parseHtmlExport ( 'manual_quartile_high', $manual_quartile_high  );
}
