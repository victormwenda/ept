...
$enable_choosing_mode_of_receipt = $data_manager_row_items ['enable_choosing_mode_of_receipt'];
	if ($enable_choosing_mode_of_receipt  != null) {
	$html_export .= $this->parseHtmlExport ( 'enable_choosing_mode_of_receipt', $enable_choosing_mode_of_receipt  );
}
$view_only_access = $data_manager_row_items ['view_only_access'];
	if ($view_only_access  != null) {
	$html_export .= $this->parseHtmlExport ( 'view_only_access', $view_only_access  );
}
...
$last_login = $data_manager_row_items ['last_login'];
	if ($last_login  != null) {
	$html_export .= $this->parseHtmlExport ( 'last_login', $last_login  );
}
