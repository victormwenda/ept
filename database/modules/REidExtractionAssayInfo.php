<?php 
	...
	*/
	public function insert($id,$name,$status,$redundancy_check= false, $printSQL = false) {
		$columns = array('id','name','status');
		$records = array($id,$name,$status);
		return $this->r_eid_extraction_assay->insert_prepared_records($id,$name,$status,$redundancy_check,$printSQL );
	}
...
$status = $r_eid_extraction_assay_row_items ['status'];
	if ($status  != null) {
