...
$qc_done = $shipment_participant_map_row_items ['qc_done'];
	if ($qc_done  != null) {
	$html_export .= $this->parseHtmlExport ( 'qc_done', $qc_done  );
}
