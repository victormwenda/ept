...
class REidExtractionAssay {
	...
	*/
     ...
     * based on the value of $id,$name,$status passed to the function
     *
     * @param $id,$name,$status
     * @return object (id)| null
     */
	public function getId($id,$name,$status) {
		$columns = array ('id','name','status');
		$records = array ($id,$name,$status);
	...
	public function getStatus($id) {
		$columns = array ('id');
		$records = array ($id);
		$status_ = $this->query_from_r_eid_extraction_assay ( $columns, $records );
	...
	*/
	public function insert_prepared_records($id,$name,$status,$redundancy_check= false, $printSQL = false) {
		$columns = array('id','name','status');
		$records = array($id,$name,$status);
