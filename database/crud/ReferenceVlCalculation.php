...
class ReferenceVlCalculation {
	...
	*/
	...
	/**
	* private class variable $_manualMean
	*/
	private $_manualMean;
	
	/**
	* returns the value of $manualMean
	*
	* @return object(int|string) manualMean
	*/
	public function _getManualMean() {
		return $this->_manualMean;
	}
	
	/**
	* sets the value of $_manualMean
	*
	* @param manualMean
	*/
	public function _setManualMean($manualMean) {
		$this->_manualMean = $manualMean;
	}
	/**
	* sets the value of $_manualMean
	*
	...
	* @return object ( this class)
	*/
	public function setManualMean($manualMean) {
		$this->_setManualMean($manualMean);
		return $this;
	}
	
	
	/**
	* private class variable $_manualSd
	*/
	private $_manualSd;
	
	/**
	* returns the value of $manualSd
	*
	* @return object(int|string) manualSd
	*/
	public function _getManualSd() {
		return $this->_manualSd;
	}
	
	/**
	* sets the value of $_manualSd
	*
	* @param manualSd
	*/
	public function _setManualSd($manualSd) {
		$this->_manualSd = $manualSd;
	}
	/**
	* sets the value of $_manualSd
	*
	...
	* @return object ( this class)
	*/
	public function setManualSd($manualSd) {
		$this->_setManualSd($manualSd);
		return $this;
	}
	
	
	/**
	* private class variable $_manualCv
	*/
	private $_manualCv;
	
	/**
	* returns the value of $manualCv
	*
	* @return object(int|string) manualCv
	*/
	public function _getManualCv() {
		return $this->_manualCv;
	}
	
	/**
	* sets the value of $_manualCv
	*
	* @param manualCv
	*/
	public function _setManualCv($manualCv) {
		$this->_manualCv = $manualCv;
	}
	/**
	* sets the value of $_manualCv
	*
	...
	* @return object ( this class)
	*/
	public function setManualCv($manualCv) {
		$this->_setManualCv($manualCv);
		return $this;
	}
	
	
	/**
	* private class variable $_manualQ1
	*/
	private $_manualQ1;
	
	/**
	* returns the value of $manualQ1
	*
	* @return object(int|string) manualQ1
	*/
	public function _getManualQ1() {
		return $this->_manualQ1;
	}
	
	/**
	* sets the value of $_manualQ1
	*
	* @param manualQ1
	*/
	public function _setManualQ1($manualQ1) {
		$this->_manualQ1 = $manualQ1;
	}
	/**
	* sets the value of $_manualQ1
	*
	...
	* @return object ( this class)
	*/
	public function setManualQ1($manualQ1) {
		$this->_setManualQ1($manualQ1);
		return $this;
	}
	
	
	/**
	* private class variable $_manualQ3
	*/
	private $_manualQ3;
	
	/**
	* returns the value of $manualQ3
	*
	* @return object(int|string) manualQ3
	*/
	public function _getManualQ3() {
		return $this->_manualQ3;
	}
	
	/**
	* sets the value of $_manualQ3
	*
	* @param manualQ3
	*/
	public function _setManualQ3($manualQ3) {
		$this->_manualQ3 = $manualQ3;
	}
	/**
	* sets the value of $_manualQ3
	*
	...
	* @return object ( this class)
	*/
	public function setManualQ3($manualQ3) {
		$this->_setManualQ3($manualQ3);
		return $this;
	}
	
	
	/**
	* private class variable $_manualIqr
	*/
	private $_manualIqr;
	
	/**
	* returns the value of $manualIqr
	*
	* @return object(int|string) manualIqr
	*/
	public function _getManualIqr() {
		return $this->_manualIqr;
	}
	
	/**
	* sets the value of $_manualIqr
	*
	* @param manualIqr
	*/
	public function _setManualIqr($manualIqr) {
		$this->_manualIqr = $manualIqr;
	}
	/**
	* sets the value of $_manualIqr
	*
	...
	* @return object ( this class)
	*/
	public function setManualIqr($manualIqr) {
		$this->_setManualIqr($manualIqr);
		return $this;
	}
	
	
	/**
	* private class variable $_manualQuartileLow
	*/
	private $_manualQuartileLow;
	
	/**
	* returns the value of $manualQuartileLow
	*
	* @return object(int|string) manualQuartileLow
	*/
	public function _getManualQuartileLow() {
		return $this->_manualQuartileLow;
	}
	
	/**
	* sets the value of $_manualQuartileLow
	*
	* @param manualQuartileLow
	*/
	public function _setManualQuartileLow($manualQuartileLow) {
		$this->_manualQuartileLow = $manualQuartileLow;
	}
	/**
	* sets the value of $_manualQuartileLow
	*
	...
	* @return object ( this class)
	*/
	public function setManualQuartileLow($manualQuartileLow) {
		$this->_setManualQuartileLow($manualQuartileLow);
		return $this;
	}
	
	
	/**
	* private class variable $_manualQuartileHigh
	*/
	private $_manualQuartileHigh;
	
	/**
	* returns the value of $manualQuartileHigh
	*
	* @return object(int|string) manualQuartileHigh
	*/
	public function _getManualQuartileHigh() {
		return $this->_manualQuartileHigh;
	}
	
	/**
	* sets the value of $_manualQuartileHigh
	*
	* @param manualQuartileHigh
	*/
	public function _setManualQuartileHigh($manualQuartileHigh) {
		$this->_manualQuartileHigh = $manualQuartileHigh;
	}
	/**
	* sets the value of $_manualQuartileHigh
	*
	...
	* @return object ( this class)
	*/
	public function setManualQuartileHigh($manualQuartileHigh) {
		$this->_setManualQuartileHigh($manualQuartileHigh);
		return $this;
	}
	...
	*/
     ...
     * based on the value of $shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range passed to the function
     *
     * @param $shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range
     * @return object (vl_assay)| null
     */
	public function getVlAssay($shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range) {
		$columns = array ('shipment_id','sample_id','vl_assay','q1','q3','iqr','quartile_low','quartile_high','mean','sd','cv','low_limit','high_limit','calculated_on','manual_mean','manual_sd','manual_cv','manual_q1','manual_q3','manual_iqr','manual_quartile_low','manual_quartile_high','manual_low_limit','manual_high_limit','updated_on','updated_by','use_range');
		$records = array ($shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range);
	...
	/**
     * Performs a database query and returns the value of manual_mean 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_mean)| null
     */
	public function getManualMean($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_mean_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_mean_)>0 ? $manual_mean_ [0] ['manual_mean'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of manual_sd 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_sd)| null
     */
	public function getManualSd($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_sd_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_sd_)>0 ? $manual_sd_ [0] ['manual_sd'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of manual_cv 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_cv)| null
     */
	public function getManualCv($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_cv_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_cv_)>0 ? $manual_cv_ [0] ['manual_cv'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of manual_q1 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_q1)| null
     */
	public function getManualQ1($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_q1_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_q1_)>0 ? $manual_q1_ [0] ['manual_q1'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of manual_q3 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_q3)| null
     */
	public function getManualQ3($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_q3_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_q3_)>0 ? $manual_q3_ [0] ['manual_q3'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of manual_iqr 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_iqr)| null
     */
	public function getManualIqr($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_iqr_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_iqr_)>0 ? $manual_iqr_ [0] ['manual_iqr'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of manual_quartile_low 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_quartile_low)| null
     */
	public function getManualQuartileLow($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_quartile_low_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_quartile_low_)>0 ? $manual_quartile_low_ [0] ['manual_quartile_low'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of manual_quartile_high 
     * based on the value of $vl_assay passed to the function
     *
     * @param $vl_assay
     * @return object (manual_quartile_high)| null
     */
	public function getManualQuartileHigh($vl_assay) {
		$columns = array ('vl_assay');
		$records = array ($vl_assay);
		$manual_quartile_high_ = $this->query_from_reference_vl_calculation ( $columns, $records );
		return sizeof($manual_quartile_high_)>0 ? $manual_quartile_high_ [0] ['manual_quartile_high'] : null;
	}
	...
	* array ('shipment_id','sample_id','vl_assay','q1','q3','iqr','quartile_low','quartile_high','mean','sd','cv','low_limit','high_limit','calculated_on','manual_mean','manual_sd','manual_cv','manual_q1','manual_q3','manual_iqr','manual_quartile_low','manual_quartile_high','manual_low_limit','manual_high_limit','updated_on','updated_by','use_range')
	* is mappped into 
	* array ($shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range)
	...
	*/
	public function insert_prepared_records($shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range,$redundancy_check= false, $printSQL = false) {
		$columns = array('shipment_id','sample_id','vl_assay','q1','q3','iqr','quartile_low','quartile_high','mean','sd','cv','low_limit','high_limit','calculated_on','manual_mean','manual_sd','manual_cv','manual_q1','manual_q3','manual_iqr','manual_quartile_low','manual_quartile_high','manual_low_limit','manual_high_limit','updated_on','updated_by','use_range');
		$records = array($shipment_id,$sample_id,$vl_assay,$q1,$q3,$iqr,$quartile_low,$quartile_high,$mean,$sd,$cv,$low_limit,$high_limit,$calculated_on,$manual_mean,$manual_sd,$manual_cv,$manual_q1,$manual_q3,$manual_iqr,$manual_quartile_low,$manual_quartile_high,$manual_low_limit,$manual_high_limit,$updated_on,$updated_by,$use_range);
