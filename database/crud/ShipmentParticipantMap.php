...
class ShipmentParticipantMap {
	...
	*/
	...
	/**
	* private class variable $_qcDone
	*/
	private $_qcDone;
	
	/**
	* returns the value of $qcDone
	*
	* @return object(int|string) qcDone
	*/
	public function _getQcDone() {
		return $this->_qcDone;
	}
	
	/**
	* sets the value of $_qcDone
	*
	* @param qcDone
	*/
	public function _setQcDone($qcDone) {
		$this->_qcDone = $qcDone;
	}
	/**
	* sets the value of $_qcDone
	...
	* @return object ( this class)
	*/
	public function setQcDone($qcDone) {
		$this->_setQcDone($qcDone);
		return $this;
	}
	...
	*/
	...
	/**
     * Performs a database query and returns the value of qc_done 
     * based on the value of $map_id passed to the function
     *
     * @param $map_id
     * @return object (qc_done)| null
     */
	public function getQcDone($map_id) {
		$columns = array ('map_id');
		$records = array ($map_id);
		$qc_done_ = $this->query_from_shipment_participant_map ( $columns, $records );
		return sizeof($qc_done_)>0 ? $qc_done_ [0] ['qc_done'] : null;
	}
