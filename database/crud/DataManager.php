<?php
	...
	/**
	* THIS SOURCE CODE WAS AUTOMATICALLY GENERATED ON Fri 05:26:38  02/12/2016
	* 
	*
...
class DataManager {
	...
	*/
	...
	/**
	* private class variable $_enableChoosingModeOfReceipt
	*/
	private $_enableChoosingModeOfReceipt;
	
	/**
	* returns the value of $enableChoosingModeOfReceipt
	*
	* @return object(int|string) enableChoosingModeOfReceipt
	*/
	public function _getEnableChoosingModeOfReceipt() {
		return $this->_enableChoosingModeOfReceipt;
	}
	
	/**
	* sets the value of $_enableChoosingModeOfReceipt
	*
	* @param enableChoosingModeOfReceipt
	*/
	public function _setEnableChoosingModeOfReceipt($enableChoosingModeOfReceipt) {
		$this->_enableChoosingModeOfReceipt = $enableChoosingModeOfReceipt;
	}
	/**
	* sets the value of $_enableChoosingModeOfReceipt
	*
	...
	* @return object ( this class)
	*/
	public function setEnableChoosingModeOfReceipt($enableChoosingModeOfReceipt) {
		$this->_setEnableChoosingModeOfReceipt($enableChoosingModeOfReceipt);
		return $this;
	}
	
	
	/**
	* private class variable $_viewOnlyAccess
	*/
	private $_viewOnlyAccess;
	
	/**
	* returns the value of $viewOnlyAccess
	*
	* @return object(int|string) viewOnlyAccess
	*/
	public function _getViewOnlyAccess() {
		return $this->_viewOnlyAccess;
	}
	
	/**
	* sets the value of $_viewOnlyAccess
	*
	* @param viewOnlyAccess
	*/
	public function _setViewOnlyAccess($viewOnlyAccess) {
		$this->_viewOnlyAccess = $viewOnlyAccess;
	}
	/**
	* sets the value of $_viewOnlyAccess
	*
	...
	* @return object ( this class)
	*/
	public function setViewOnlyAccess($viewOnlyAccess) {
		$this->_setViewOnlyAccess($viewOnlyAccess);
		return $this;
	}
	...
	*/
	...
	/**
	* private class variable $_lastLogin
	*/
	private $_lastLogin;
	...
	*
	* @return object(int|string) lastLogin
	*/
	...
	/**
	* sets the value of $_lastLogin
	*
	* @param lastLogin
	*/
	public function _setLastLogin($lastLogin) {
	...
	*/
     ...
     * based on the value of $dm_id,$primary_email,$password,$institute,$first_name,$last_name,$phone,$secondary_email,$UserFld1,$UserFld2,$UserFld3,$mobile,$force_password_reset,$qc_access,$enable_adding_test_response_date,$enable_choosing_mode_of_receipt,$view_only_access,$status,$created_on,$created_by,$updated_on,$updated_by,$last_login passed to the function
     *
     * @param $dm_id,$primary_email,$password,$institute,$first_name,$last_name,$phone,$secondary_email,$UserFld1,$UserFld2,$UserFld3,$mobile,$force_password_reset,$qc_access,$enable_adding_test_response_date,$enable_choosing_mode_of_receipt,$view_only_access,$status,$created_on,$created_by,$updated_on,$updated_by,$last_login
     * @return object (dm_id)| null
     */
	public function getDmId($dm_id,$primary_email,$password,$institute,$first_name,$last_name,$phone,$secondary_email,$UserFld1,$UserFld2,$UserFld3,$mobile,$force_password_reset,$qc_access,$enable_adding_test_response_date,$enable_choosing_mode_of_receipt,$view_only_access,$status,$created_on,$created_by,$updated_on,$updated_by,$last_login) {
		$columns = array ('dm_id','primary_email','password','institute','first_name','last_name','phone','secondary_email','UserFld1','UserFld2','UserFld3','mobile','force_password_reset','qc_access','enable_adding_test_response_date','enable_choosing_mode_of_receipt','view_only_access','status','created_on','created_by','updated_on','updated_by','last_login');
		$records = array ($dm_id,$primary_email,$password,$institute,$first_name,$last_name,$phone,$secondary_email,$UserFld1,$UserFld2,$UserFld3,$mobile,$force_password_reset,$qc_access,$enable_adding_test_response_date,$enable_choosing_mode_of_receipt,$view_only_access,$status,$created_on,$created_by,$updated_on,$updated_by,$last_login);
	...
	/**
     * Performs a database query and returns the value of enable_choosing_mode_of_receipt 
     * based on the value of $dm_id passed to the function
     *
     * @param $dm_id
     * @return object (enable_choosing_mode_of_receipt)| null
     */
	public function getEnableChoosingModeOfReceipt($dm_id) {
		$columns = array ('dm_id');
		$records = array ($dm_id);
		$enable_choosing_mode_of_receipt_ = $this->query_from_data_manager ( $columns, $records );
		return sizeof($enable_choosing_mode_of_receipt_)>0 ? $enable_choosing_mode_of_receipt_ [0] ['enable_choosing_mode_of_receipt'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of view_only_access 
     * based on the value of $dm_id passed to the function
     *
     * @param $dm_id
     * @return object (view_only_access)| null
     */
	public function getViewOnlyAccess($dm_id) {
		$columns = array ('dm_id');
		$records = array ($dm_id);
		$view_only_access_ = $this->query_from_data_manager ( $columns, $records );
		return sizeof($view_only_access_)>0 ? $view_only_access_ [0] ['view_only_access'] : null;
	}
	...
	/**
     * Performs a database query and returns the value of last_login 
     * based on the value of $dm_id passed to the function
     *
     * @param $dm_id
     * @return object (last_login)| null
     */
	public function getLastLogin($dm_id) {
		$columns = array ('dm_id');
		$records = array ($dm_id);
		$last_login_ = $this->query_from_data_manager ( $columns, $records );
		return sizeof($last_login_)>0 ? $last_login_ [0] ['last_login'] : null;
	}
	...
	* array ('dm_id','primary_email','password','institute','first_name','last_name','phone','secondary_email','UserFld1','UserFld2','UserFld3','mobile','force_password_reset','qc_access','enable_adding_test_response_date','enable_choosing_mode_of_receipt','view_only_access','status','created_on','created_by','updated_on','updated_by','last_login')
	* is mappped into 
	* array ($dm_id,$primary_email,$password,$institute,$first_name,$last_name,$phone,$secondary_email,$UserFld1,$UserFld2,$UserFld3,$mobile,$force_password_reset,$qc_access,$enable_adding_test_response_date,$enable_choosing_mode_of_receipt,$view_only_access,$status,$created_on,$created_by,$updated_on,$updated_by,$last_login)
	...
	*/
	public function insert_prepared_records($dm_id,$primary_email,$password,$institute,$first_name,$last_name,$phone,$secondary_email,$UserFld1,$UserFld2,$UserFld3,$mobile,$force_password_reset,$qc_access,$enable_adding_test_response_date,$enable_choosing_mode_of_receipt,$view_only_access,$status,$created_on,$created_by,$updated_on,$updated_by,$last_login,$redundancy_check= false, $printSQL = false) {
		$columns = array('dm_id','primary_email','password','institute','first_name','last_name','phone','secondary_email','UserFld1','UserFld2','UserFld3','mobile','force_password_reset','qc_access','enable_adding_test_response_date','enable_choosing_mode_of_receipt','view_only_access','status','created_on','created_by','updated_on','updated_by','last_login');
		$records = array($dm_id,$primary_email,$password,$institute,$first_name,$last_name,$phone,$secondary_email,$UserFld1,$UserFld2,$UserFld3,$mobile,$force_password_reset,$qc_access,$enable_adding_test_response_date,$enable_choosing_mode_of_receipt,$view_only_access,$status,$created_on,$created_by,$updated_on,$updated_by,$last_login);
