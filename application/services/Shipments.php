    ...
    public function echoAllShipments($parameters) {
        ...
        */
        $sQuery = $db->select()->from(array('s' => 'shipment'))
            ->join(array('d' => 'distributions'), 'd.distribution_id = s.distribution_id', array('distribution_code', 'distribution_date','distribution_id','distribution_status'=>'status'))
        ...
        foreach ($rResult as $aRow) {
            ...
            if ($aRow['distribution_status'] == 'configured') {
