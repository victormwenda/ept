    ...
    public function resultHeaderAction() {
        ...
        if (!isset($authNameSpace->dm_id)) {
            ...
            if ($this->getRequest()->isPut()) {
                ...
                $response = array(
                    'sampleRehydrationDate' => Pt_Commons_General::humanDateFormatOrNull($shipment['attributes']['sample_rehydration_date']),
	                'testDate' => Pt_Commons_General::humanDateFormatOrNull($shipment['shipment_test_date']),
                    'mtbRifKitLotNo' => $shipment['attributes']['mtb_rif_kit_lot_no'],
	                'expiryDate' => Pt_Commons_General::humanDateFormatOrNull($shipment['attributes']['expiry_date']),
	                'testReceiptDate' => Pt_Commons_General::humanDateFormatOrNull($shipment['shipment_test_report_date']),
	                ...
	                'qcDate' => Pt_Commons_General::humanDateFormatOrNull($shipment['qc_date']),
	                'qcDoneBy' => $shipment['qc_done_by'],
                    'dateReceived' => Pt_Commons_General::humanDateFormatOrNull($shipment['shipment_receipt_date']),
        ...
        if (!isset($authNameSpace->dm_id)) {
            ...
            if ($this->getRequest()->isPut()) {
                ...
                $response = array(
                    ...
                    'instrumentInstalledOn' => Pt_Commons_General::humanDateFormatOrNull($sample['res_instrument_installed_on']),
                    'instrumentLastCalibratedOn' => Pt_Commons_General::humanDateFormatOrNull($sample['res_instrument_last_calibrated_on']),
                    'dateTested' => Pt_Commons_General::humanDateFormatOrNull($sample['res_date_tested']),
                    ...
                    'cartridgeExpirationDate' => Pt_Commons_General::humanDateFormatOrNull($sample['res_cartridge_expiration_date']),
